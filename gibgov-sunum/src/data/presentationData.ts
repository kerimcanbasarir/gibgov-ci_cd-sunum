        ...
        content: [
          {
            type: "text",
            content:
              "GitHub Actions, GitHub reposunda doğrudan CI/CD pipeline'ları oluşturmanızı sağlayan bir otomasyon platformudur.",
          },
          {
            type: "list",
        ...
        content: [
          {
            type: "text",
            content:
              "GitHub Actions'da hassas verileri güvenli şekilde yönetmek için Secrets ve Environment Variables kullanılır.",
          },
          {
            type: "code",
            language: "yaml",
        ...
        content: [
          {
            type: "text",
            content:
              "DRY prensibi: Tekrar eden workflow'ları bir kez tanımlayıp, birden fazla yerde kullanın.",
          },
          {
            type: "code",
            language: "yaml",
        ...
        content: [
          {
            type: "text",
            content:
              "Vercel ve Netlify, modern web uygulamalarını deploy etmek için en popüler iki platform. Her ikisi de JAMstack ve serverless mimariye odaklanır.",
          },
          {
            type: "comparison",
            content: "Genel Bakış",
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            type: "highlight",
            content:
              "Her iki platform da mükemmel. Proje gereksinimlerinize göre seçin!",
          },
        ],
      },
    ],
        ...
        content: [
          {
            type: "text",
            content:
              'Docker, uygulamaları container\'lar içinde paketleyip çalıştırmanızı sağlayan bir platformdur. "Works on my machine" problemini ortadan kaldırır.',
          },
          {
            type: "diagram",
            content: `
        ...
        content: [
          {
            type: "text",
            content:
              "Docker Compose, multi-container uygulamaları tanımlayıp çalıştırmanızı sağlar.",
          },
          {
            type: "code",
            language: "yaml",
        ...
        content: [
          {
            type: "text",
            content:
              "Kubernetes (K8s), container'ize edilmiş uygulamaları otomatik deploy, scale ve yönetmenizi sağlayan açık kaynak bir container orchestration platformudur.",
          },
          {
            type: "list",
        ...
        content: [
          {
            type: "text",
            content:
              "HPA, CPU/memory kullanımı veya custom metrics'e göre otomatik olarak Pod sayısını scale eder.",
          },
          {
            type: "code",
            language: "yaml",
      ...
      - type: Percent
        ...
        periodSeconds: 15`,
          },
          {
            type: "highlight",
            content:
              "CPU %70'i geçince otomatik scale-up, %70 altına düşünce 5 dk bekleyip scale-down",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "text",
            content:
              "Helm, Kubernetes uygulamalarını paketlemek, paylaşmak ve deploy etmek için kullanılan bir package manager'dır.",
          },
          {
            type: "code",
            language: "yaml",
        ...
        content: [
          {
            type: "text",
            content:
              "Doğru deployment stratejisi seçimi, downtime'ı minimize eder ve risk yönetimini kolaylaştırır.",
          },
          {
            type: "list",
  ...
  strategy:
    type: Recreate`,
          },
          {
            type: "highlight",
            content:
              "Use case: Dev/test ortamları, breaking DB migrations, legacy uygulamalar",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "text",
            content:
              "GitOps, Git'i single source of truth olarak kullanarak declarative infrastructure ve application yönetimi yapar.",
          },
          {
            type: "diagram",
            content: `
...
export const getTotalSlides = () => {
  return presentationData.reduce(
